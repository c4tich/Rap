...
columns = [
    ...
    "number_of_songs",
    "number_of_stopwords",
    "percentage_of_relevant_words",
    "text_no_sw",
    "text_raw",
    "unique_words",
    "word_average_per_song",
    "style",
]
...
def compare_artists(lyrics_data, estilo):
    ...
    artist_data.plot(
        kind="bar",
        x="_id",
        y=["max_words_per_song", "word_average_per_song", "min_words_per_song"],
    )
...
def swarmplot(feature_tag=tags.percentage_of_relevant_words):
    ...
    with sns.color_palette(
        ["#8ED752", "#F95643", "#53AFFE", "#C3D221", "#BBBDAF", "#AD5CA2", "#F8E64E"],
        n_colors=56,
        desat=0.9,
    ):
        plt.figure(figsize=(12, 10))
        sns.swarmplot(
            x="style", y="value", data=melted_df, hue="_id", split=True, size=7
        )
